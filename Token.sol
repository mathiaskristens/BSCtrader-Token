...
contract BSCtrader is IERC20, ReentrancyGuard, Ownable {
    ...
    function sellForETH(uint256 amountIn) public nonReentrant returns (bool) { 
    ...
    function transferFrom(address holder, address recipient, uint amount) external override returns (bool) {
